summon armor_stand ~ ~ ~ {Motion:[0.0, 1.0, 0.0],Tags:["new","frag"],Invisible:1b,Invulnerable:1b,Passengers:[{id:"minecraft:block_display",Tags:["meteor_display"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.5f,-1.5f,-0.5f],scale:[1f,1f,1f]},block_state:{Name:"minecraft:magma_block"}}]}
