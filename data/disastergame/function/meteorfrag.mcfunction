...
execute store result entity @e[type=falling_block,tag=new,limit=1] Motion[0] double 0.001 run random value -2000..2000
execute store result entity @e[type=falling_block,tag=new,limit=1] Motion[1] double 0.001 run random value 500..1500
execute store result entity @e[type=falling_block,tag=new,limit=1] Motion[2] double 0.001 run random value -2000..2000
