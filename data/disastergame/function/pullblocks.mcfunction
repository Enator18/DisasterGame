scoreboard players add &recursiveCount2 temp 1
...
execute if score &recursiveCount2 temp matches ..30 if score &blocks temp matches ..100 run function disastergame:pullblocks