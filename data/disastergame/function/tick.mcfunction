...
execute at @e[type=marker,tag=tornado_emitter] as @e[type=armor_stand,tag=tornado,tag=new] run rotate @s ~ ~
tag @e[type=block_display,tag=tornado,tag=new] remove new
tag @e[type=armor_stand,tag=tornado,tag=new] remove new
