...
#Tornado
execute at @e[type=marker,tag=tornado_emitter] run summon block_display ~ ~ ~ {interpolation_duration:5,teleport_duration:5,Tags:["tornado","new"],Passengers:[{id:"minecraft:marker",Tags:["tornado","tornado_particle"]}],block_state:{Name:"minecraft:cobweb"}}
execute at @e[type=marker,tag=tornado_emitter] run summon block_display ~ ~ ~ {interpolation_duration:5,teleport_duration:5,Tags:["tornado","new"],Passengers:[{id:"minecraft:marker",Tags:["tornado","tornado_particle"]}],block_state:{Name:"minecraft:cobweb"}}
execute at @e[type=marker,tag=tornado_emitter] run summon block_display ~ ~ ~ {interpolation_duration:5,teleport_duration:5,Tags:["tornado","new"],Passengers:[{id:"minecraft:marker",Tags:["tornado","tornado_particle"]}],block_state:{Name:"minecraft:cobweb"}}
